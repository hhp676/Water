...
//					this.setWebUrl(PropertyUtils.getPropertyValue("env", "resource.webUrl")+"/"+this.url);
	...
	private void setUrl(String physicalPath) {
	...
	private String getPhysicalPath(String path) {
		...
		/*HttpSession sessio = this.request.getSession();
		String realPath = sessio.getServletContext().getRealPath("/");
		
		return new File(realPath) + "/" + path;*/
		
		String uploadPath = PropertyUtils.getPropertyValue("env", "umeditor.imagePath");
