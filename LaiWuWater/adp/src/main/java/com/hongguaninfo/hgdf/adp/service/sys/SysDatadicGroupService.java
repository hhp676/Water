...
import com.hongguaninfo.hgdf.adp.dao.sys.SysDatadicGroupDao;
...
public class SysDatadicGroupService {
    ...
    public void updateDatadicGroup(SysDatadicGroup sysDatadicGroup)
            throws BizException {
//    	SysDatadicGroup vo = new SysDatadicGroup();
//    	vo.setGroupCode(sysDatadicGroup.getGroupCode());
//    	List<SysDatadicGroup> checkResultList = sysDatadicGroupDao .getList(vo);
//        if (checkResultList != null && checkResultList.size() > 0) {
//        	vo = checkResultList.get(0);
//        	if(!vo.getGroupId().equals(sysDatadicGroup.getGroupId())){
//        		throw new BizException(JSON.toJSONString(new CheckFieldResult(
//        				"groupCode", "字典组code已经存在")));
//        	}
//        }
