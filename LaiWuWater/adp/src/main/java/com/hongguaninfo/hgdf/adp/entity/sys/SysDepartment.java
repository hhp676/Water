...
public class SysDepartment extends BaseEntity {
    ...
    private String departNameForQuery;
    ...
    private String departCodeForQuery;
  ...
  //统计该部门的人数
    private java.math.BigDecimal userCount;
	...
	public String getDepartNameForQuery() {
		return departNameForQuery;
	}

	public void setDepartNameForQuery(String departNameForQuery) {
		this.departNameForQuery = departNameForQuery;
	}

	public String getDepartCodeForQuery() {
		return departCodeForQuery;
	}

	public void setDepartCodeForQuery(String departCodeForQuery) {
		this.departCodeForQuery = departCodeForQuery;
	}

	public java.math.BigDecimal getUserCount() {
		return userCount;
	}

	public void setUserCount(java.math.BigDecimal userCount) {
