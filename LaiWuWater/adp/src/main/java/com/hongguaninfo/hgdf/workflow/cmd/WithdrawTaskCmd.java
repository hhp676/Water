package com.hongguaninfo.hgdf.workflow.cmd;
...
import com.hongguaninfo.hgdf.adp.core.utils.spring.ApplicationContextHelper;
import com.hongguaninfo.hgdf.workflow.graph.ActivitiHistoryGraphBuilder;
import com.hongguaninfo.hgdf.workflow.graph.Edge;
import com.hongguaninfo.hgdf.workflow.graph.Graph;
import com.hongguaninfo.hgdf.workflow.graph.Node;
...
public class WithdrawTaskCmd implements Command<Integer> {
    ...
    public void deleteHistoryActivities(List<String> historyNodeIds) {
        ...
        for (String id : historyNodeIds) {
            String taskId = jdbcTemplate.queryForObject("select task_id_ from ACT_HI_ACTINST where id_=?",
                    String.class, id);
