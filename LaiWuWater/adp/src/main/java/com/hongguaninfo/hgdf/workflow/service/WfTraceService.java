...
import com.hongguaninfo.hgdf.workflow.utils.WfBasicUtils;
...
public class WfTraceService {
    ...
    private Map<String, Object> packageSingleActivitiInfo(ActivityImpl activity, ProcessInstance processInstance,
        ...
        vars.put("任务类型", WfBasicUtils.parseToZhType(properties.get("type").toString()));
