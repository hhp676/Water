...
import com.hongguaninfo.hgdf.adp.core.utils.generator.IdBlock;
import com.hongguaninfo.hgdf.adp.dao.sys.SysConfigDao;
...
public class SysConfigService {
    ...
    public void doBatchUpdateSysCfg(String jsonListStr) {
        ...
        for (SysConfig vo : list) {
            String configKey = vo.getConfigKey().substring(Constants.ONE,
                    vo.getConfigKey().length() - Constants.ONE);
