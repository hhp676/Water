...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {totalinfo} items",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$(_1f0).html($("<div class=\"panel-loading panel-loading-hg\" style='width:100%;height:100%;position:absolute;background-color:#ffffff;z-index:10;'></div>").html(opts.loadingMessage));
}
$.ajax({url:opts.href,cache:false,dataType:"html",success:function(data){
_1f3(opts.extractor.call(_1f0,data));
opts.onLoad.apply(_1f0,arguments);
$(_1f0).children(".panel-loading-hg").remove();
_1f1.isLoaded=true;
}});
}
}else{
