...
var overPlanType= "overPlan";
waMonthWaterDatagrid.initwaMonthWaterData = function(){
   	Hg.fixTableHeight("waMonthWaterData_datagrid_overPlan",true);
    //----------------------------------查询-----------------------------------------------------
	$("#waMonthWaterData_toolbar_overPlan [tag='search']").click(function(){
    ...
    //----------------------------------清空-----------------------------------------------------
	$("#waMonthWaterData_toolbar_overPlan [tag='clear']").click(function(){
		$('#waMonthWaterDataSearchForm_overPlan').form('clear');
		$('#waMonthWaterData_datagrid_overPlan').datagrid("load",{});
	});
	/* //-------------------------------------------增加---------------------------------------------------
	$("#waMonthWaterData_toolbar_overPlan [tag='add']").click(function(){
		waMonthWaterDatagrid.mode = "add";
        // waMonthWaterDatagrid.selCompany = "0";
        var monthWaterId = 0;
        var companyId=0;
        var row = $("#waMonthWaterData_datagrid_overPlan").datagrid("getSelected");
		if (row){
	...
	//-------------------------------------------修改---------------------------------------------------
	$("#waMonthWaterData_toolbar_overPlan [tag='edit']").click(function(){
        ...
        var url = "/wa/WaMonthWaterData/waMonthWaterDataDetail/"+monthWaterId + "/" + overPlanType;
        var iconCls = $(this).attr("iconCls");
	...
	//-------------------------------------------查看详情---------------------------------------------------
	$("#waMonthWaterData_toolbar_overPlan [tag='view']").click(function(){
	...
	//-------------------------------------------删除---------------------------------------------------
	$("#waMonthWaterData_toolbar_overPlan [tag='del']").click(function(){
		var row = $("#waMonthWaterData_datagrid_overPlan").datagrid("getSelected");
		if (!row) {
			$.messager.alert("提示","请选择一条数据","warning");
			return;
    ...
    //-------------------------------------------打印功能---------------------------------------------------
    $("#waMonthWaterData_toolbar_overPlan [tag='print']").click(function(){
	...
	//---------------------导入----------------------------------------------------------
	$("#waMonthWaterData_toolbar_overPlan [tag='import']").click(function(){
    ...
    //---------------------汇总excel----------------------------------------------------------
    $("#waMonthWaterData_toolbar_overPlan [tag='sumExcel']").click(function(){
