...
waCompanyInfoDatagrid.initwaCompanyInfo = function(){
   	Hg.fixTableHeight("waCompanyInfo_datagrid_edit",true);
    //----------------------------------查询-----------------------------------------------------
	$("#waCompanyInfo_toolbar_edit [tag='search']").click(function(){
		 $('#waCompanyInfo_datagrid_edit').datagrid('load',{
             companyCode: $("[name='com_companyCode_edit']").val(),
             companyName: $("[name='com_companyName_edit']").val(),
             isImport: $("[name='com_isImport_edit']").val()
		 });
	});

    //----------------------------------清空-----------------------------------------------------
	$("#waCompanyInfo_toolbar_edit [tag='clear']").click(function(){
		$('#waCompanyInfoSearchForm_edit').form('clear');
		$('#waCompanyInfo_datagrid_edit').datagrid("load",{});
	});
	 //-------------------------------------------增加---------------------------------------------------
/*	$("#waCompanyInfo_toolbar_insert [tag='add'],#waCompanyInfo_contextMenu_insert [tag='add']").click(function(){
	...
	//-------------------------------------------修改---------------------------------------------------
	$("#waCompanyInfo_toolbar_edit [tag='edit'],#waCompanyInfo_contextMenu_edit [tag='edit']").click(function(){
...
*/
  /*  //-------------------------------------------用水情况统计信息---------------------------------------------------
    $("#waCompanyInfo_toolbar_edit [tag='statisticsView']").click(function(){
        waCompanyInfoDatagrid_edit.mode = "statisticsView";
        var row = $("#waCompanyInfo_datagrid_edit").datagrid("getSelected");
        if (!row) {
            $.messager.alert("提示","请选择一条数据","warning");
            return;
	...
	/*//---------------------导入----------------------------------------------------------
    $("#waCompanyInfo_toolbar_edit [tag='import']").click(function(){
        waCompanyInfoDatagrid_edit.mode = "import";
        var iconCls = $(this).attr("iconCls");
...
waCompanyInfoDatagrid.onLoadSuccess = function(data) {
	Hg.showGridCellTip("waCompanyInfo_datagrid_edit",waCompanyInfoDatagrid.tipCells);
}
Hg.removeMenu("waCompanyInfo_contextMenu");

/*waCompanyInfoDatagrid_edit.onRowContextMenu = function(e,row){
	Hg.removeMenu("waCompanyInfo_contextMenu");
	$('#waCompanyInfo_datagrid_edit').datagrid("selectRow",row);
	e.preventDefault();
...
/*
waCompanyInfoDatagrid_edit.onDblClickRow = function(){
