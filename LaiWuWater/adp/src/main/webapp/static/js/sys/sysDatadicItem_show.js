...
sysDatadicItem.tipCells = ["itemCode","itemName", "itemValue","itemDesc","groupCode","groupName"];
sysDatadicItem.initSysDatadicItemShow = function() {
	...
	$("#sysDatadicItem_toolbar [tag='add'],#sysDatadicItem_contextMenu [tag='add']").click(function(){
		...
		var sysDatadicItemDetailWin = new HgWin({id:"sysDatadicItemDetailWin",title:"添加系统字典项",width:530,height:400,iconCls:iconCls,url:"/sys/datadic/item/sysDatadicItemDetail/0"});
	});
	...
	$("#sysDatadicItem_toolbar [tag='edit'],#sysDatadicItem_contextMenu [tag='edit']").click(function(){
		...
		var iconCls = $(this).attr("iconCls");
		var sysDatadicItemDetailWin = new HgWin({id:"sysDatadicItemDetailWin",title:"修改系统字典项",width:530,height:400,iconCls:iconCls,url:editUrl});
	});
...
sysDatadicItem.onLoadSuccess = function(data) {
	Hg.showGridCellTip("sysDatadicItem_grid",sysDatadicItem.tipCells);
	//Hg.removeMenu("sysDatadicItem_contextMenu");
}
//Hg.removeMenu("sysDatadicItem_contextMenu");
