...
<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'">
		<div id="tab" class="easyui-tabs" data-options="fit:true,border:false,plain:true,tools:'#tab-tools'">
			<div title="用水数据管理" id="homeTab" data-options="href:'${ctx}/wa/WaMonthWaterData/showActWaterDataSearch',tools:'#p-tools',iconCls:'acc_icon_other',tabWidth:120" style="padding:5px"></div>
		</div>
