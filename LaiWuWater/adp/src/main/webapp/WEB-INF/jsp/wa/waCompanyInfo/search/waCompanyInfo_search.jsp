...
<body>
 <div title="列表">
 		<table  id="waCompanyInfo_datagrid_search" singleSelect=true  fitColumns=true  toolbar='#waCompanyInfo_toolbar_search'
       	...
       	<div id="waCompanyInfo_toolbar_search" style="display: none;">
       		<div class="gridSearchBar" style="height: 40px;">
			<form id="waCompanyInfoSearchForm_search">
       			<table width="100%">
						<tr>
							<td width="60px" align="right"><span>节水代码:</span></td>
							<td width="120px;"><input name="com_companyCode_search"></td>
							<td width="120px" align="right"><span>单位名称:</span></td>
							<td><input name="com_companyName_search"></td>
							<td width="120px" align="right"><span>重点用户:</span></td>
							<td>
								<select style="width: 120px;" name="com_isImport_search">
...
<script type="text/javascript" src="${ctx}/static/js/wa/waCompanyInfo/search/waCompanyInfo_search.js"></script>
</body>
