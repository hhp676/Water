...
<body>
	<div >
 		<table id="waMonthWaterData_datagrid_plan" singleSelect=true  fitColumns=true  toolbar='#waMonthWaterData_toolbar_plan'
 		    class="easyui-datagrid" data-options="url:'${ctx}/wa/WaMonthWaterData/planList'"
			pagination="true" 
       	...
       	<div id="waMonthWaterData_toolbar_plan" style="display: none;">
       		<div class="gridSearchBar" style="height: 40px;">
				<form id="waMonthWaterDataSearchForm_plan">
					<table width="100%">
						<tr>
							<td width="60px" align="right"><span>节水代码:</span></td>
							<td width="50px;"><input style="width: 120px" name="month_companyCodeMonth_plan"></td>
							...
							<td>
								<select name="month_isImportMonth_plan" style="width: 80px">
							...
							<td><select name="month_isOverroof_plan" style="width: 80px">
								<option selected="selected" value="">全部</option>
								<option value="1">是</option>
								<option value="0">否</option>
							</select></td>--%>
