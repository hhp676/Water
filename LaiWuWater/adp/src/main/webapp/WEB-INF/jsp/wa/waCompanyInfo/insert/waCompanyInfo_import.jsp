...
<div style="padding-top: 20px;">
    <form   method="post" enctype="multipart/form-data"  id="companyInfoImportExcel" class="hgform">
        <table width="98%" border="0" cellpadding="0" align="center" cellspacing="1" class="hgtable">
            <tr>
                <td align="center">选择导入文件<font>*</font>:
                </td>
                <td align="left" ><input name="excelFile" type="file"  class="form-input"  id="companyInfoExcelFile" /></td>
                <td><input name="import" type="button" value="导&nbsp;&nbsp;入" onclick="userAjaxFileUpload()"/>&nbsp;
                    <a href="${ctx}/static/template/单位信息.xls" target="_blank">模板下载</a>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    $("#companyInfoImportExcel").validate({
        rules : {
            excelFile : {
                required : true
            }
    ...
    function userAjaxFileUpload(){
        if(!$('#companyInfoImportExcel').validate().form()) return false;
        ...
        $.ajaxFileUpload({
            //处理文件上传操作的服务器端地址
            url:"${ctx}/wa/WaCompanyInfo/importExcel",
