...
<body>
 <div title="列表">
 		<table id="waCompanyInfo_datagrid_waterTotal" singleSelect=true  fitColumns=true  toolbar='#waCompanyInfo_toolbar_waterTotal'
       	...
       	<div id="waCompanyInfo_toolbar_waterTotal" style="display: none;">
       		<div class="gridSearchBar" style="height: 40px;">
			<form id="waCompanyInfoSearchForm_waterTotal">
       			<table width="100%">
						<tr>
							<td width="60px" align="right"><span>节水代码:</span></td>
							<td width="120px;"><input name="com_companyCode_waterTotal"></td>
							<td width="120px" align="right"><span>单位名称:</span></td>
							<td><input name="com_companyName_waterTotal"></td>
							<td width="120px" align="right"><span>重点用户:</span></td>
							<td>
								<select style="width: 120px;" name="com_isImport_waterTotal">
