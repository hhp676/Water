...
<body>
	<div >
 		<table id="waMonthWaterData_datagrid_actSearch" singleSelect=true  fitColumns=true  toolbar='#waMonthWaterData_toolbar_actSearch'
       	...
       	<div id="waMonthWaterData_toolbar_actSearch" style="display: none;">
       		<div class="gridSearchBar" style="height: 40px;">
				<form id="waMonthWaterDataSearchForm_actSearch">
					<table width="100%">
						<tr>
							<td width="60px" align="right"><span>节水代码:</span></td>
							<td width="50px;"><input style="width: 120px" name="month_companyCodeMonth_actSearch"></td>
							<td width="60px" align="right"><span>单位名称:</span></td>
							<td width="50px;"><input style="width: 120px" name="month_companyNameMonth_actSearch"></td>
							<td width="60px" align="right"><span>年份:</span></td>
							<td width="50px;"><input style="width: 50px;" name="month_waYear" id="month_waYear_actSearch"></td>
							<td width="30px" align="right"><span>月份:</span></td>
							<td width="40px;"><input style="width: 50px;"  name="month_waMonth_actSearch"></td>
							<td width="60px" align="right"><span>重点用户:</span></td>
							<td>
								<select name="month_isImportMonth_actSearch" style="width: 80px">
							...
							<td><select name="month_isOverroof_actSearch" style="width: 80px">
								<option selected="selected" value="">全部</option>
								<option value="1">是</option>
								<option value="0">否</option>
							</select></td>--%>
...
<script type="text/javascript" src="${ctx}/static/js/wa/waterDataManagement/search/waActWaterData_search.js"></script>
