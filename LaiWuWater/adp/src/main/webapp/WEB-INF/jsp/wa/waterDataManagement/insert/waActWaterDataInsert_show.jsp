...
<body>
	<div >
 		<table id="waMonthWaterData_datagrid_actInsert" singleSelect=true  fitColumns=true  toolbar='#waMonthWaterData_toolbar_actInsert'
				...
				<form id="waMonthWaterDataSearchForm_actInsert">
					<table width="100%">
						<tr>
							...
							<td width="50px;"><input style="width: 50px;" name="month_waYear" id="month_waYear_actInsert"></td>
