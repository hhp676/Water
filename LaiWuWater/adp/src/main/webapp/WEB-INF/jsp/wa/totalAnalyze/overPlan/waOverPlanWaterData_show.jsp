...
<body>
	<div >
 		<table id="waMonthWaterData_datagrid_overPlan" singleSelect=true  fitColumns=true  toolbar='#waMonthWaterData_toolbar_overPlan'
				...
				<form id="waMonthWaterDataSearchForm_overPlan">
					<table width="100%">
						<tr>
							...
							<td width="50px;"><input style="width: 50px;" name="month_waYear" id="month_waYear_overPlan"></td>
