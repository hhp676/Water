...
<body>
				...
				<table class="hgtable">
					...
					<tr id="fNode">
						...
						<td><input class="easyui-validatebox" type="text"
							name="fNode" value="" style="width: 180px;" disabled="disabled"></input></td>
					</tr>
					<tr>
						<td width="160px;">部门名称<font>*</font>:
						</td>
						<td><input class="easyui-validatebox" type="text"  
							name="departName" value="${departObj.departName }"
							style="width: 180px;"></input></td>
					</tr>
					<tr>
						<td>部门全名:</td>
						<td><input class="easyui-validatebox" type="text"  
							name="departFullname" value="${departObj.departFullname }"
							style="width: 180px;"></input></td>
					</tr>
					<tr>
						<td>部门code<font>*</font>:
						</td>
						<td><input  type="text" name="departCode" value="${departObj.departCode }"  
							style="width: 180px;"></input></td>
					</tr>
					<tr>
						<td>英文名:</td> 
						<td><input class="easyui-validatebox" type="text"  
							name="engname" value="${departObj.engname }"
							style="width: 180px;"></input></td>
					</tr>
				</table>
			</form>
	...
	<script type="text/javascript"
		src="${ctx}/static/js/sys/sysDepartment_detail.js"></script>
