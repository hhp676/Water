...
<html>
  ...
  <body>
  	 ...
  	 <table striped=true id="sysOper_grid" singleSelect=true fitColumns=true fit=true toolbar='#sysOper_toolbar' class="easyui-datagrid"  rownumbers="true"
      data-options="url:'${ctx}/sys/authoper/list',
      onLoadSuccess:onLoadSysOperSuccess
      "
       pagination="true" pageSize="${defaultPageSize}" pageList="${defaultPageList}">
	      <thead>
		      <tr>
                 <th data-options="field:'operId',width:30,hidden:true">操作类型Id</th>
                 <th data-options="field:'operCode',width:80">操作类型code</th>
                 <th data-options="field:'operName',width:100">操作类型名称</th>
 				 <th data-options="field:'operEnname',width:100">操作类型英文名称</th>
