	...
	<div class="easyui-layout" data-options="fit:true" id="sysUserGroupDetail_layout">
		<div data-options="region:'east',split:true" style="width:380px">
			 <div  class="easyui-tabs" fit=true tabPosition="top">
			 	<div title="设置部门" style="padding:2px">
            		<table fit=true  singleSelect=true fitColumns=true name="departTree" id="userGroup_departTree">
        				<thead>
            				 <tr>
            				 	<th data-options="field:'departId'"  formatter=departTreeFmt>部门Id</th>
			 	...
			 	<div title="设置角色" style="padding:2px">
            		<table title="" fit=true  singleSelect=false fitColumns=true name="roleGrid" id="userGroup_roleGrid">
        				<thead>
            				<tr>
        		...
        		<div title="设置权限" style="padding:2px">
            		<table fit=true name="authTree" singleSelect=false fitColumns=true id="userGroup_authTree">
        				<thead>
            				<tr>
            					<th data-options="field:'isChecked',checkbox:true"></th>  
		...
		<div data-options="region:'center'" style="padding: 10 10 10 20px;" title="基本信息">
			<form id="sysUserGroup_form" class="hgform">
				...
				<table class="hgtable">
					<tr>
						<td width="100px;">用户组名称<font>*</font>:</td>
						<td><input    type="text" name="groupName" value="${userGroup.groupName}" style="width: 170px;"></input></td>
					</tr>
					<tr>
						<td>用户组code<font>*</font>:</td>
						<td>
							<input   type="text" name="groupCode" value="${userGroup.groupCode}" style="width: 170px;"></input>
						</td>
					</tr>
					<tr name="fIdRow">
						<td>父用户组:</td>
						<td>
							<input    type="text" name="fName" value="${userGroup.fName}" style="width: 170px;" disabled="disabled"></input>
					...
					<tr>
						<td>描述:</td>
						<td><textarea   name="descr" style="height:50px;width:246px;font-family:Arial;font-size:13.3333px;">${userGroup.descr}</textarea></td>
					</tr>
