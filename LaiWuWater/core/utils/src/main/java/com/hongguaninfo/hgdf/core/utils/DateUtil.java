...
public class DateUtil {
     ...
     * 一分钟的总毫秒数。
     */
    public static final long   MIN_MILLISECOND       = 60 * 1000L;
     ...
     * @return 是否
     */
    public static boolean isMinsInterval(Date date, int mins) {
        Calendar now = Calendar.getInstance();
        return (now.getTimeInMillis() - date.getTime()) <= (MIN_MILLISECOND * mins);
    }
}
