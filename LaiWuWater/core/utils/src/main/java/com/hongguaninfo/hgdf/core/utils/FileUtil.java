...
public class FileUtil {
     ...
     * @param content
     */
    public static void addContentByFile(String file, String content) {
        BufferedWriter out = null;
        try {
            out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file, true)));
            out.write(content);
        } catch (Exception e) {
            LOG.error("addContentByFile fail!", e);
        } finally {
            try {
                out.close();
            } catch (IOException e) {
     ...
     * @param content
     */
    public static void addContentByFileName(String fileName, String content) {
        try {
            ...
            LOG.error("addContentByFileName fail!", e);
        }
    }
    ...
    public static void readFileByLines(String fileName) {
        ...
        try {
            ...
            LOG.error("readFileByLines fail!", e);
        } finally {
            if (reader != null) {
                try {
                    reader.close();
                } catch (IOException e1) {
                    LOG.error("readFileByLines fail!", e1);
                    ;
                }
            }
        }
    ...
    static void readAppointedLineNumber(File sourceFile, int lineNumber) throws IOException {
        ...
        {
            while (s != null) {
                LOG.debug("当前行号为:" + reader.getLineNumber());
                System.exit(0);
                s = reader.readLine();
            }
        }
    ...
    public static boolean delFile(String filePathAndName) {
        ...
        try {
            ...
            LOG.error(filePathAndName + "删除文件操作出错！", e);
        }
        return bea;
    }
     ...
     * @return
     */
    public static void copyDefaultFile(String oldPathFile, String newPathFile) {
        try {
            int bytesum = 0;
            int byteread = 0;
            File oldfile = new File(oldPathFile);
            String fileName = oldfile.getName();
            String resultFile = newPathFile + "\\" + fileName;
            // 文件存在时
            if (oldfile.exists()) {
                // 读入原文件
                InputStream inStream = new FileInputStream(oldPathFile);
