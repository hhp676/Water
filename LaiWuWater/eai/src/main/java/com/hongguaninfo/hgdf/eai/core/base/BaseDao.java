package com.hongguaninfo.hgdf.eai.core.base;
...
* @param <PK>
 */
public abstract class BaseDao<E, M, PK extends Serializable> extends
	...
	public void delete(E entity) {
		int affectCount = getSqlSession().delete(
				getMapperNamesapce() + ".delete", entity);
	}
	...
	public void multiDelete(String ids) {
		int affectCount = getSqlSession().delete(
				getMapperNamesapce() + ".multiDelete", ids);
	}
