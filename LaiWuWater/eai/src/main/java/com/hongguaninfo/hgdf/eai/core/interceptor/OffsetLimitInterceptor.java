package com.hongguaninfo.hgdf.eai.core.interceptor;
...
/**
 * 2012-08-14 由于源代码不兼容mybatis3.1 故在此修改覆盖
 * henry
 *
...
public class OffsetLimitInterceptor implements Interceptor{
	...
	public void setProperties(Properties properties) {
		...
		log.debug(OffsetLimitInterceptor.class.getSimpleName()+".dialect="+dialectClass);
	}
